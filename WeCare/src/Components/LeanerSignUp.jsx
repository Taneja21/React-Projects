...
{/* Looking for?  */}        
        ...
        <fieldset >
            <legend className="col-form-label pt-0 form-label">Looking for?</legend>
            <div className="row m-3">
              ...
              <div className="form-check col-3">
                ...
                />
                <label className="form-check-label" htmlFor="finance and accounting">
                Finance & Accounting
                </label>
              </div>
              <div className="form-check col-3">
            ...
            <div className="row m-3">
              <div className="form-check col-3">
                ...
                />
                <label className="form-check-label" htmlFor="officeproductivity">
                Office Productivity
                </label>
              </div>
              <div className="form-check col-3">
                ...
                />
                <label className="form-check-label" htmlFor="personaldevelopment">
